...
const TABS_CONFIG = {
    ...
    //   ⚠️⚠️ 本榜 360 天回放 **14 天为空** ⇒ 那几天橱窗 0 行、后端 audit D 项报错（站长知情拍板的取舍，见后端 TEASER_TAB 上方）。
...
const TAB_GROUPS = [
    ...
    },
    {
        ...
        //
        // 【现状分类】（**2026-09-12 1x:xx（当日最后一条）站长「移除：日线9/21扩张＋SAR多头前七根。置顶：日线二到六连阳＋
        ...
        //     **同日最后一条移除 `dailyEmaSarFirstTwo` ⇒ 14**）⇒ 全站 **17** 个榜。
        //
