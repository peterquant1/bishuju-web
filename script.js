...
const TAB_GROUPS = [
    ...
    },
    {
        ...
        //
        // 【现状分类】（2026-09-11 08:5x `dailyFourBull` 改判据为「日线两连阳＋价涨量增」＋ 新增周线版 `weeklyTwoBullExactCloseVolRising` 之后）
        ...
        //   · **周线榜八个**（09-11 08:5x 新增 `weeklyTwoBullExactCloseVolRising` 前七个）/ **月线榜三个**（`monthlySarFirstBar` / `monthlyFourBull` / `monthlyFiveBear`；09-10 一度六个，
        //     09-11 08:1x 移除三个）/ **日线榜三个**（`dailyEmaSarFirstTwo` / `dailySarFirstBar` / `dailyFourBull`；09-11 06:4x 一度四个）。
        //
