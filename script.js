...
const TAB_GROUPS = [
    ...
    },
    {
        ...
        //     一次带来三对，回到六对 → **13:3x 移除 `weeklyTripleEma` 带走一对 ⇒ 五对**）
        ...
        //   · **互斥：九对**（三对 → 一对 → 09-10 12:1x 新增三个周线连阳/连阴榜后四对 → 当日第 6 条新增 `monthlyTwoBullExact` 后六对 → **第 7 条新增 `monthlyBullAfterThreeBear` 后九对**），全是判据保证：
        ...
        //   · **周线榜七个**（09-10 12:1x 由五个变八个，13:3x 移除 `weeklyTripleEma` 后七个）/ **月线榜五个**（当日第 6 条加 `monthlyTwoBullExact`、第 7 条加 `monthlyBullAfterThreeBear`）/ 日线榜一个。
        //
