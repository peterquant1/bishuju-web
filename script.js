...
const TABS_CONFIG = {
    ...
    // 榜 ⇒ 六个 → 2026-08-01 复活 monthlyWeeklySar ⇒ 七个 → 2026-08-07 同日站长两次新增
    // dailyTripleEmaCvd 与 dailyFourEmaExpansion ⇒ **九个**。被移除各榜判据存档见后端
    ...
    // ⑨ **日线 EMA9/21/55/200 四线扩张（1 个条件）** —— 2026-08-07 站长「新增一个TAB，逻辑是：
    // 最新已收盘日线是EMA9/21/55/200扩张。」（同日第二条，没点资产 ⇒ 加密）
...
const TAB_GROUPS = [
    ...
    },
    {
        ...
        // → 2026-08-01 复活 monthlyWeeklySar ⇒ 七个 → 2026-08-07 同日站长两次新增：
        // dailyTripleEmaCvd（日线9/21/55扩张＋CVD递增）与 dailyFourEmaExpansion
        ...
        tabs: [
            ...
            // tf 日线。⚠️ 2026-08-07 站长（同日第二条）逐字：「新增一个TAB，逻辑是：最新已
