...
// A股 策略榜的 **16 轴**，**轴序与加密的 cryptoStrategySorts 完全对齐、只少一根「日订单流」**：
// 日成交额·日涨跌幅·日线RSI·日CVD强弱·〔加密这里是日订单流，A股 没有〕·日量比·日EMA间距·
// 日ADX·日+DI·日MACD强弱·日波动幅度 + 周线RSI·周线EMA间距·周ADX·周+DI·周MACD强弱 + 月线RSI。
...
// 轴数履历：11 → 14 → 16（2026-07-30 对齐）→ **仍 16（2026-08-19 只重排不增减）**。
