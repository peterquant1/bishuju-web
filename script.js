...
const TAB_GROUPS = [
    ...
    },
    {
        ...
        //
        // 【现状分类】（2026-09-11 08:1x 一次移除四个榜之后）
        ...
        //     · **`dailyFourBull`（日线恰好 4 连阳，09-11 新增；相邻两日交集恒空）**
        ...
        //   · 纯 K 线形态、零指标（**六个**）：`monthlyFourBull` / `monthlyFiveBear` + `weeklySixBull` / `weeklyFourBull` /
        //     `weeklyFiveBear` + `dailyFourBull`（09-11 06:4x 一度九个；08:1x 移除月线两连阳 / 三连阴后首阳与日线两连阳后六个）
        //
        // 【结构性关系 —— 2026-09-11 08:1x 起】
        ...
        //   · **互斥：四对**（三对 → 一对 → 09-10 12:1x 新增三个周线连阳/连阴榜后四对 → 月线两连阳 / 三连阴后首阳 /
        //     两连阳＋成交量递增、09-11 日线两连阳陆续把它加到十三对 → **09-11 08:1x 这四个榜一次移除、带走九对 ⇒ 四对**），全是判据保证：
        ...
        //   · **周线榜七个** / **月线榜三个**（`monthlySarFirstBar` / `monthlyFourBull` / `monthlyFiveBear`；09-10 一度六个，
