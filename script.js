...
const TABS_CONFIG = {
    ...
    dailySarBearFirstDivergenceWeeklySarBull: { sorts: cryptoStrategySorts, subFormat: (v, sf) => axesSub(v, sf, "日成交额") },
    ...
    },
    {
        ...
        tabs: [
            ...
            { key: "dailySarBearFirstDivergence", name: "日线SAR空头首根＋SAR点高于前一轮空头首根＋月线突破SAR空头第二根低点", tf: "日线/月线",
              desc: "三个条件：前两个落在最新已收盘的那根日线上，第三个看最新已收盘的那根月线。一是这根日线是这一轮 Parabolic SAR 空头的首根——SAR 圆点刚刚在这一天由价格下方翻到上方，前一天还在多头一侧；二是这根日线上的 SAR 圆点，比前一轮空头趋势首根那根日线上的 SAR 圆点更高；三是最新已收盘那根月线的收盘价，站上了最近一轮月线 SAR 空头段里第 2 根 K 线的最低价（和「月线突破SAR空头第二根低点」那张榜的条件一字不差）。拆开说第二条：SAR 由多翻空的那一根，圆点会直接跳到刚结束那一波上涨的最高价附近，所以「空头首根的圆点」基本就是这一波上涨的顶；拿它和前一轮空头首根的圆点比，比的是这一波的顶有没有高过上一波的顶——这一波创了更高的高点、日线趋势却翻了空，也就是这里说的背离。再拆开说第三条：在月线上找到最近一轮 SAR 处在空头（圆点在 K 线上方）的那一段，取这一段第 2 根月 K 的最低价当参照线，最新已收盘月线的收盘价高过这条线才算——也就是只在月线级别已经从最近一轮下跌里抬起头的标的里找日线上的这种背离；「最近一轮」不要求那一段已经结束，段里只有 1 根、或者可用历史里一次空头都没出现过的标的没有参照线，不入榜。有四处要先说清楚。第一，「前一轮空头」是从这根日线往回数、越过刚结束的那段多头之后遇到的那一段日线空头，取它的第一根；那一根必须是真正由多翻空的——日线只取最近约 500 根，最早那段空头的开头可能不在窗口里，这种没有可靠参照的标的不入榜。第二，两个圆点的比较是严格大于，一样高不算。第三，除了日线 SAR 和月线收盘价，本榜不看成交量和其他指标。第四，本榜的每一个标的必然都在「月线突破SAR空头第二根低点」上（第三条和那张一字不差），反过来差得很远：那张是月线门槛清单、成员常年几十到一两百个，本榜只是其中恰好这一天日线翻空、SAR 顶又高过上一轮的那几个。另有一张「日线SAR空头首根＋SAR点高于前一轮空头首根＋周线SAR多头」：前两条和本榜一字不差，第三条换成最新已收盘周线的 SAR 在多头一侧；两张之间没有包含关系，回放里本榜约一半的成员同时在那张榜上。和「日线SAR多头前四根」正好相反：那张要求最新一根日线的 SAR 在多头一侧，本榜要求刚翻到空头，同一个标的不会同时出现在两张榜上；表格里的「日SAR多头根数」在本榜上一定显示「—」。这是一张事件清单：翻空当天出现，第二天要么继续空头成了第二根、要么翻回多头，都会离开本榜，同一个标的不会连着两天出现；月线那一条每月 1 号 00:00（UTC）新月线收盘后才换一次，同一个月之内能入选的范围不变。命中数很少，空榜很常见：回放过去 360 天，每天中位 1 个、最多 31 个，有 94 天一个都没有（约四分之一的天数）；只看前两条时每天中位 4 个、19 天空榜，加上月线这一条后大约只留下四分之一；改成现在这个判据时（最新已收盘的是 2026 年 9 月 13 日那根日线）从 12 个变成 3 个。次日去向：约 97% 第二天仍在空头（成了第二根），约 3% 翻回多头。也要如实说一句：加上月线这一条并没有让它更会挑。回放里本榜成员次日收涨的比例 46.2%（691 个样本），只看前两条时 46.5%，同期全市场 45.3%；5 天后收涨的比例 43.7%，只看前两条时 45.3%，全市场 42.1%——差距都很小，它不是做空或做多信号。表格里的各轴都不参与筛选，用来在这批标的里再分强弱。上市不足 23 天的新合约日线数据不够、已收盘月线不足 3 根的算不出月线参照线，都不入榜；日线数据每天 00:00（UTC）收盘后才换一批，同一天之内反复打开本榜，看到的标的完全一样，这是正确行为不是数据卡住了。范围是全部加密 USDT 永续合约。" },
            { key: "dailySarBearFirstDivergenceWeeklySarBull", name: "日线SAR空头首根＋SAR点高于前一轮空头首根＋周线SAR多头", tf: "日线/周线",
              desc: "三个条件：前两个落在最新已收盘的那根日线上，第三个看最新已收盘的那根周线。一是这根日线是这一轮 Parabolic SAR 空头的首根——SAR 圆点刚刚在这一天由价格下方翻到上方，前一天还在多头一侧；二是这根日线上的 SAR 圆点，比前一轮空头趋势首根那根日线上的 SAR 圆点更高；三是最新已收盘那根周线的 SAR 还在多头一侧（圆点在 K 线下方）。拆开说第二条：SAR 由多翻空的那一根，圆点会直接跳到刚结束那一波上涨的最高价附近，所以「空头首根的圆点」基本就是这一波上涨的顶；拿它和前一轮空头首根的圆点比，比的是这一波的顶有没有高过上一波的顶——这一波创了更高的高点、日线趋势却翻了空，也就是这里说的背离。第三条把范围收窄到周线趋势仍然向上的标的：日线刚翻空、周线还没翻，看到的是更大一级上升趋势里的一次日线级回落。有四处要先说清楚。第一，「前一轮空头」是从这根日线往回数、越过刚结束的那段多头之后遇到的那一段日线空头，取它的第一根；那一根必须是真正由多翻空的——日线只取最近约 500 根，最早那段空头的开头可能不在窗口里，这种没有可靠参照的标的不入榜。第二，两个圆点的比较是严格大于，一样高不算。第三，周线只看最新已收盘那一根的 SAR 方向，不管它已经多头了几周；周线数据每周一 00:00（UTC）新周线收盘后才刷新一次，同一周之内第三条的结果不变。第四，除了日线 SAR 和周线 SAR 方向，本榜不看收盘价、成交量和其他指标。和「日线SAR空头首根＋SAR点高于前一轮空头首根＋月线突破SAR空头第二根低点」的关系：前两条一字不差，只有第三条不同（那张看月线收盘价有没有站上 SAR 空头第二根低点，本榜看周线 SAR 方向），两张之间没有包含关系，回放里本榜约三成的成员同时在那张榜上。和「周线SAR多头＋RSI≥50」也没有包含关系：那张还要求周线 RSI 不低于 50，本榜不看 RSI；反过来那张完全不看日线。和「日线SAR多头前四根」正好相反：那张要求最新一根日线的 SAR 在多头一侧，本榜要求刚翻到空头，同一个标的不会同时出现在两张榜上；表格里的「日SAR多头根数」在本榜上一定显示「—」。这是一张事件清单：翻空当天出现，第二天要么继续空头成了第二根、要么翻回多头，都会离开本榜，同一个标的不会连着两天出现。命中数不多，遇到空榜也正常：回放过去 360 天，每天中位 2 个、最多 34 个，有 55 天一个都没有；只看前两条时每天中位 4 个、19 天空榜，其中约四成的成员周线 SAR 在多头一侧；上线当天是 7 个。次日去向：约 97% 第二天仍在空头（成了第二根），约 3% 翻回多头。它不是做空或做多信号：回放里本榜成员次日收涨的比例 45.4%（1110 个样本），只看前两条时 46.5%，同期全市场 45.3%；5 天后收涨的比例 45.8%，只看前两条时 45.3%，全市场 42.1%——差距都很小。表格里的各轴都不参与筛选，用来在这批标的里再分强弱。上市不足 23 天的新合约日线数据不够、已收盘周线不足 3 根的算不出周线 SAR，都不入榜；日线数据每天 00:00（UTC）收盘后才换一批，同一天之内反复打开本榜，看到的标的完全一样，这是正确行为不是数据卡住了。范围是全部加密 USDT 永续合约。" },
        ],
    },
