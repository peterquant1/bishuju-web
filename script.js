...
const TAB_GROUPS = [
    ...
    },
    {
        ...
        //
        // 【现状分类】（2026-09-11 13:2x `monthlyVolRising` 追加「月线阳K」改名「月线成交量递增＋阳K」之后；11:0x 新增它；更早 08:5x `dailyFourBull` 改判据 ＋ 新增 `weeklyTwoBullExactCloseVolRising`）
        ...
        //   · **周线榜八个**（09-11 08:5x 新增 `weeklyTwoBullExactCloseVolRising` 前七个）/ **月线榜四个**（`monthlySarFirstBar` / `monthlyFourBull` / `monthlyFiveBear` /
